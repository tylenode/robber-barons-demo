...
<script lang="ts">
    ...
    $: if ($A2EDAdata) {
        ...
        console.log("hi", neighborhood, median_sale_price);
    }
...
<div class="card-wrapper">
    ...
    <img class="rent_p" src={monopoly_hotel} />
    <div class="list_p">
        <p>Flipper annual return: <strong>{median_sale_price}k</strong></p>
    </div>
</div>
...
<style>
	...
	.rent_p   {position:absolute; left: 20%; top:30%; width:60%;}
